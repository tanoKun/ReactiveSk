package com.github.tanokun.reactivesk.v263.skript.resolve.variable
    ...
    companion object {
        fun register() {
            Skript.registerEffect(LocalTypedVariableDeclarationEffect::class.java,
                "[declare] (val | immutable) %identifier% [\\(%-classinfo%\\)] \\:= %object%",
                "[declare] (var | mutable) %identifier% [\\(%-classinfo%\\)] \\:= %object%",
                "[declare] (val | immutable) %identifier% \\(%-classinfo%\\)",
                "[declare] (var | mutable) %identifier% \\(%-classinfo%\\)",
            )
        }
    }
