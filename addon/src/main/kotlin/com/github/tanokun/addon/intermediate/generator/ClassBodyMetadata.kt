...
const val INTERNAL_FUNCTION_TRIGGER_PREFIX: String = INTERNAL_PREFIX + $$"trigger$fun$"
const val INTERNAL_FUNCTION_NAME_PREFIX: String = INTERNAL_PREFIX + "fun$"
...
fun internalFunctionNameOf(funcName: String): String = "$INTERNAL_FUNCTION_NAME_PREFIX$funcName"
